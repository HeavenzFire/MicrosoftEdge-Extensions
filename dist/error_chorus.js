...
exports.ErrorChorusProtocol = void 0;
const crypto_1 = __importDefault(require("crypto"));
class ErrorChorusProtocol {
    salt;
    legacyAnchor;
    baseFrequency; // Base Schumann resonance
    memorialOffset; // Memorial frequency offset
    voices;
    constructor() {
    ...
    calculateFrequency(coherencePct) {
...
exports.ErrorChorusProtocol = ErrorChorusProtocol;
...
//# sourceMappingURL=error_chorus.js.map